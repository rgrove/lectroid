...
Paginator.prototype = {
    ...
    // pages before, after, and including the current page, or returns `null` if
    // the current page is the only page and no navigation links are needed.
    get navigation () {
