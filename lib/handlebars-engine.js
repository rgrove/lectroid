...
// Hacky. Shouldn't rely on hardcoded view directory.
var partials = glob.sync('**/*.{handlebars,hbs}', {cwd: __dirname + '/../views/partials'});

// TODO: cache compiled partials when in production mode.
partials.forEach(function (filename) {
    var content = fs.readFileSync(__dirname + '/../views/partials/' + filename, 'utf8');
